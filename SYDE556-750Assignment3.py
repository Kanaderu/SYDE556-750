...
def get_rate_decoders(neurons,x,S,noise):
...
def get_function_decoders(neurons,x,S,noise,function):
...
def one():
    ...
    d=get_rate_decoders(neurons,x_sample,S,noise)
