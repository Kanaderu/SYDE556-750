...
\subsubsection{Plot $x(t)$ for three randomly generated signals with \texttt{limit} at 5, 10, and 20Hz. For each of these, \texttt{T}=1,\texttt{dt}=0.001, and \texttt{rms}=0.5.}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_5_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_7_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_10_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_12_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_15_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
\subsection{Does the observed number of spikes in the previous part
...
\subsection{Plot the spike output for $x(t)$ generated using your
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_19_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
\subsection{Using the same $x(t)$ signal as in part (c), plot the
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_21_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
 \subsection{BONUS: How could you improve this simulation (in terms of
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_26_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
\subsection{Plot $x(t)$ and the spiking output for $x(t)=1$ (one
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_28_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
\subsection{Plot $x(t)$ and the spiking output for $x(t)=\frac{1}{2} sin(10\pi t)$ (a sine wave at 5Hz).}\label{c-plot-xt-and-the-spiking-output-for-xt1-over-2sin10pi-t-a-sine-wave-at-5hz.}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_30_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
\subsection{Plot $x(t)$ and the spiking output for a random signal
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_32_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
\section{Computing an Optimal Filter}\label{computing-an-optimal-filter}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_35_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_35_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_35_2.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_38_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_43_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_43_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_48_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_48_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{SYDE_556-750_Assignment_2_files/SYDE_556-750_Assignment_2_48_2.png}
    \end{center}
    { \hspace*{\fill} \\}
