...
def oxy_function(t):
    if t_train+t_control<t<t_train+t_control+t_oxy: return 1 #oxytocin application phase
    return 0

def GABA_function(t):
    if t_train+t_control+t_oxy<t<t_train+t_control+t_oxy+t_gaba: return 1 #gaba application phase
    return 0
